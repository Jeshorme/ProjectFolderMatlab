function AudioGUI
    ...
    % 按钮回调
    function fastForwardButtonCallback(hObject, eventdata)
        currentPosition = min(length(audioData), currentPosition + 4410);
        updatePositionLabel();
    end
