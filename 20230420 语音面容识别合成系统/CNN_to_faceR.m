...
% clear all;
% 导入训练集和测试集
trainImages = imageDatastore('C:\Users\64148\Desktop\兼职工作文件夹\20230420（700）\orl_faces','IncludeSubfolders',true,'LabelSource','foldernames');
testImages = imageDatastore('C:\Users\64148\Desktop\兼职工作文件夹\20230420（700）\orl_faces','IncludeSubfolders',true,'LabelSource','foldernames');
