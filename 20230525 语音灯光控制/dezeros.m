% [x,fs]=audioread('C:\Users\64148\Desktop\兼职工作文件夹\20230525（1050）语音灯光控制\Soundfiles\red\red.wav');
function y=dezeros(x)
x = double(x);
x = x / max(abs(x));
...
% subplot(121)    %subplot(3,1,1)表示将图排成3行1列，最后的一个1表示下面要画第1幅图
% plot(x)
