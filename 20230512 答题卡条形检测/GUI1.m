...
[FileName,PathName,~] = uigetfile('*.*','请选择答题卡');
str1=sprintf('后续思路\n\n');
str4=sprintf('           由于时间仓促，如需帮助，联系老师微信：matlab2022   \n');
string=[str1 str4];
msgbox(string,'温馨提示','none');
return
set(handles.text14,'String',strcat(PathName,FileName));
[pass,sum_scores,I4,tips] = SimplePaper_Inspection( ...
    get(handles.text14,'String'));
axes(handles.axes4);
imshow(I4);
set(handles.edit4,'String',tips);
set(handles.text15,'String',pass);
set(handles.text18,'String',num2str(sum_scores));
